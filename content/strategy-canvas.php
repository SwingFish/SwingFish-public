...
?><div class="col-md-6"><div id="chartContainer"></div>
...
<script type="text/javascript">
	...
	$.get("http://localhost/Code/Projects/trade/swingfish.trade/assets/strategies/1000/history.csv", function(data) {
...
<? if ((isset($products['settings']['BackupFundsLevel']))&&($products['settings']['BackupFundsLevel'] >0)) {?>
						<div class="col-md-2 col-sm-4 col-xs-12">
							<div class="progressbars--item">
								<div data-value="<?=(($Coverstats['backedby']/100)*$products['settings']['BackupFundsLevel'])?>%" data-options='{"color":"#f4b642","trailColor":"#d5eaf7"}' class="progressbar"></div>
